...
const KEY = '20269151-404055dda6d70ef88ef54d848';
...
const createSlider = () => {
  ...
  `;
    ...
    sliders.forEach(slide => {
      ...
      item.innerHTML = `<img class="w-100 bg-warning"
      src="${ slide }"
      alt="">`;
    ...
    alert('If you are looking to create slider, then please type time duration number on the below box. Minimum time duration number: 500!')
  }
}
...
function onLoader() {
  onloder = setTimeout(showPage, 1500);
}
